...
%% Outputs description:
% DoM: 1x1 double, represents the global Degree of Mixing measured between first k1 clusters of CL_1 with
%      first k2 clusters of CL_2.
% LocalMixingDegree: 1xk2 double array, indicates the local degree of mixing measured for first k2 clusters in CL_2.
%% Read Me:
